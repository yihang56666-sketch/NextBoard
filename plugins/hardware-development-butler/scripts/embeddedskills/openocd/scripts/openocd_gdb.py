...
def main() -> None:
    ...
    safety_cli.require_gate(
        ...
        target=oc_params["target"] or oc_params["board"] or "",
        probe=oc_params["interface"] or oc_params["board"] or "OpenOCD",
        voltage=args.voltage,
        current_limit=args.current_limit,
        recovery=args.recovery,
        backend="openocd-gdb",
        external_loads=args.external_loads,
        artifact=args.safety_artifact or args.elf or state_lookup.get("debug_file") or "",
